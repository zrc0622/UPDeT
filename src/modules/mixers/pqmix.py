...
class PQMixer(nn.Module):
    def __init__(self, args):
        super(PQMixer, self).__init__()
        ...
        if self.args.agent in ['phase_updet2'] and self.args.pqmix_v2:
            ...
            self.state_dim = self.state_dim + self.args.phase_num # 毕设结题
    ...
    def forward(self, agent_qs, states, phase_representation):
        bs = agent_qs.size(0)
        states = th.cat((states, phase_representation), -1)
